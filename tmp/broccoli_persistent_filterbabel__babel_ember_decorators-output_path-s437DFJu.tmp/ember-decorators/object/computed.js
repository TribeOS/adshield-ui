define('ember-decorators/object/computed', ['exports', '@ember-decorators/utils/decorator-macros'], function (exports, _decoratorMacros) {
   ...
   */
  const alias = exports.alias = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.alias);
   ...
   */
  const and = exports.and = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.and);
   ...
   */
  const bool = exports.bool = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.bool);
   ...
   */
  const collect = exports.collect = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.collect);
   ...
   */
  const deprecatingAlias = exports.deprecatingAlias = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.deprecatingAlias);
   ...
   */
  const empty = exports.empty = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.empty);
   ...
   */
  const equal = exports.equal = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.equal);
   ...
   */
  const filter = exports.filter = (0, _decoratorMacros.decoratedPropertyWithOptionalCallback)(Ember.computed.filter);
   ...
   */
  const filterBy = exports.filterBy = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.filterBy);
   ...
   */
  const gt = exports.gt = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.gt);
   ...
   * @param {Number} value - Value to compare against
   */
  const gte = exports.gte = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.gte);
   ...
   */
  const intersect = exports.intersect = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.intersect);
   ...
   * @param {Number} value - Value to compare against
   */
  const lt = exports.lt = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.lt);
   ...
   * @param {Number} value - Value to compare against
   */
  const lte = exports.lte = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.lte);
   ...
   */
  const map = exports.map = (0, _decoratorMacros.decoratedPropertyWithOptionalCallback)(Ember.computed.map);
   ...
   */
  const mapBy = exports.mapBy = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.mapBy);
   ...
   */
  const match = exports.match = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.match);
   ...
   */
  const max = exports.max = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.max);
   ...
   * @param {String} dependentKey - Key for the array to find the max value of
   */
  const min = exports.min = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.min);
   ...
   * @param {String} dependentKey - Key for the property to check
   */
  const none = exports.none = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.none);
   ...
   */
  const not = exports.not = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.not);
   ...
   * @param {String} dependentKey - Key for the property to check
   */
  const notEmpty = exports.notEmpty = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.notEmpty);
   ...
   * @param {String} dependentKey - Key for the property to alias
   */
  const oneWay = exports.oneWay = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.oneWay);
   ...
   */
  const or = exports.or = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.or);
   ...
   */
  const reads = exports.reads = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.reads);
   ...
   */
  const setDiff = exports.setDiff = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.setDiff);
   ...
   */
  const sort = exports.sort = (0, _decoratorMacros.decoratedPropertyWithEitherCallbackOrProperty)(Ember.computed.sort);
   ...
   */
  const sum = exports.sum = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.sum);
   ...
   */
  const union = exports.union = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.union);
   ...
   */
  const uniq = exports.uniq = (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.uniq);
   ...
   */
  const uniqBy = exports.uniqBy = true ? (0, _decoratorMacros.decoratedPropertyWithRequiredParams)(Ember.computed.uniqBy) : () => {
