...
define("adshield-front/templates/stats", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "Eq+W1q/j", "block": "{\"symbols\":[\"stat\",\"data\"],\"statements\":[[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"model\"]]],null,{\"statements\":[[0,\"\\t\\t\"],[6,\"div\"],[9,\"class\",\"col-md-4\"],[7],[0,\"\\n\\t\\t\\t\"],[6,\"div\"],[9,\"style\",\"border: 1px solid #6dbafc; min-height: 200px;\"],[7],[0,\"\\n\\t\\t\\t\\t\"],[6,\"div\"],[9,\"style\",\"border-bottom: 1px solid #6dbafc; padding: 10px;\"],[7],[0,\"\\n\\t\\t\\t\\t\\t\"],[6,\"div\"],[9,\"style\",\"color: #a7a9ac;line-height: 40px; font-size: 24px;\"],[9,\"class\",\"text-center\"],[7],[1,[19,1,[\"title\"]],false],[8],[0,\"\\n\\t\\t\\t\\t\"],[8],[0,\"\\n\\t\\t\\t\\t\"],[6,\"div\"],[7],[0,\"\\n\"],[4,\"each\",[[19,1,[\"data\"]]],null,{\"statements\":[[0,\"\\t\\t\\t\\t\\t\"],[6,\"div\"],[9,\"style\",\"padding: 10px; background: #183247;margin:5px;\"],[7],[6,\"span\"],[9,\"style\",\"color: #8f989b\"],[7],[1,[19,2,[\"title\"]],false],[0,\" :\"],[8],[0,\" \"],[6,\"span\"],[9,\"style\",\"color: #6dbafc;\"],[7],[1,[19,2,[\"amount\"]],false],[8],[8],[0,\"\\n\"]],\"parameters\":[2]},null],[0,\"\\t\\t\\t\\t\"],[8],[0,\"\\n\\t\\t\\t\"],[8],[0,\"\\n\\t\\t\"],[8],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"\\n\"],[8]],\"hasEval\":false}", "meta": { "moduleName": "adshield-front/templates/stats.hbs" } });
});
...
if (!runningTests) {
  require("adshield-front/app")["default"].create({"name":"adshield-front","version":"0.0.0+eabde5d2"});
}
