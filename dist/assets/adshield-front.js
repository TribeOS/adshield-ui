...
define("adshield-front/adapters/ipviolatorgraph", ["exports", "adshield-front/adapters/application"], function (exports, _application) {
	"use strict";
	...
	exports.default = _application.default.extend({
		pathForType() {
			return "ipviolatorgraph";
		}
	});
});
define("adshield-front/adapters/ipviolatorslist", ["exports", "adshield-front/adapters/application"], function (exports, _application) {
	"use strict";
...
if (!runningTests) {
  require("adshield-front/app")["default"].create({"LOG_RESOLVER":true,"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"adshield-front","version":"0.0.0+932cf74c"});
}
